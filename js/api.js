 ...
 * A persistência usa localStorage no lugar de System.IO.
 *
 * CLASSES C# ESPELHADAS ESPELHADAS:
 *   Evento        → DB.evento
...
(function () {
  ...
  //   List<Atividade>    → DB.atividades
  //   map<string,bool>     → DB.inscritos  (anti-duplicata)
  //   List<Participante> → DB.participantes
  ...
  // Salva estado (espelha File.WriteAllText())
  ...
  /**
   * getAtividades()
   * Espelha: Evento::getAtividades() → List<Atividade>
